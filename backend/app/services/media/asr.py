...
class AliyunASRService:
    ...
    def _create_request(self, action: str, params: Optional[dict] = None, method: str = "POST") -> CommonRequest:
    ...
    def get_task_result(self, task_id: str) -> dict:
        if not self.client or task_id == "mock_task_id":
            return {
                "status": "SUCCESS",
                "text": "【Mock】这是本地模拟的转写结果。请配置阿里云 AccessKey 以启用真实转写。",
                "sentences": [],
            }
