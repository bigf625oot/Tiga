...
from app.services.domain.chatbi.semantic_layer import SemanticLayer
from app.services.intelligence.knowledge.rag.retrieval.engines.lightrag import lightrag_engine
from app.services.intelligence.nlu.classifier import QueryIntent
...
class SmartDataQueryService:
    ...
    def _get_config_from_source_id(self, source_id: int) -> DbConnectionConfig:
        ...
        from app.services.ops.pipeline.connectors.bridge import SessionLocal, decrypt_field
