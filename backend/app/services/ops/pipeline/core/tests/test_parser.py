...
from app.services.ops.pipeline.core.exceptions import ConfigurationError
...
class TestDAGParser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.source_patcher = patch('app.services.ops.pipeline.core.parser.get_source')
        self.mock_get_source = self.source_patcher.start()
        
        self.sink_patcher = patch('app.services.ops.pipeline.core.parser.get_sink')
        self.mock_get_sink = self.sink_patcher.start()
        
        self.registry_patcher = patch('app.services.ops.pipeline.core.parser.OperatorRegistry')
