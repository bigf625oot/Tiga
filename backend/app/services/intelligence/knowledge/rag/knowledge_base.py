...
from app.services.intelligence.knowledge.rag.config.settings import UPLOAD_DIR
    ...
    def _embed_texts(self, texts: List[str]) -> List[List[float]]:
        try:
            ...
            embedder = OpenAIEmbedder(
                ...
                model=cfg.get("id") or "text-embedding-3-small",
            )
    ...
    def delete_document(self, filename: str):
        try:
            ...
            try:
                ...
                # Already inside an event loop (e.g., FastAPI request context): schedule on it
