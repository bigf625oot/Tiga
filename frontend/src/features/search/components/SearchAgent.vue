<template>
  <div class="max-w-[1000px] mx-auto p-4">
    ...
    <div v-if="!loading && !hasSearched" class="text-center py-10">
        ...
        <p class="text-slate-500 max-w-md mx-auto">聚合全网信息，为您提供精准的行业情报。</p>
    </div>
    <!-- Search Box Area -->
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-8">
        ...
        <div v-if="showAdvanced" class="mt-6 pt-6 border-t border-slate-100 grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in slide-in-from-top-2 duration-200">
            <div class="space-y-2">
                <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider">关键词分组标签</label>
                <input 
            ...
            <div class="space-y-2">
                <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider">时间范围</label>
                <select 
            ...
            <div class="space-y-2">
                <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider">关键词限定条件</label>
                <input 
            ...
            <div class="space-y-2">
                <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider">返回结果要求</label>
                <input 
            ...
            <div class="col-span-1 md:col-span-2 space-y-2">
                <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider">搜索来源</label>
