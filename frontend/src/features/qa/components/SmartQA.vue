<template>
  <div class="h-full flex bg-white overflow-hidden relative">
    ...
    <div class="flex-1 flex flex-col h-full bg-white relative">
        ...
        <div v-if="messages.length === 0" class="flex-1 flex flex-col items-center justify-center p-4 md:p-8 bg-white overflow-y-auto relative bg-animated custom-scrollbar">
        ...
        <div v-else class="flex-1 overflow-y-auto p-6 space-y-6 bg-slate-50/30 custom-scrollbar" ref="messagesContainer">
