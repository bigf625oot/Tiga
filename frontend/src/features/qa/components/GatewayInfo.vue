  ...
  <div class="p-6 h-full overflow-y-auto">
    ...
    <div v-else class="space-y-4">
      ...
      <div class="bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
        ...
        <div class="text-xs text-muted-foreground">版本: {{ info.version || '未知' }}</div>
      </div>
...
/**
 * @场景    在自动任务工作台中查看 OpenClaw 网关连接与鉴权状态
 * @功能    拉取并展示网关 URL、连接状态、重连信息与密钥可见性切换
 * @依赖    Vue3、TypeScript、/api/v1/openclaw/info 接口
 * @备注    页面可显示敏感字段，生产环境建议增加权限控制与脱敏策略
 */
