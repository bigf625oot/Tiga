...
import { ref } from 'vue';
import AutoTaskPanel from '@/features/llm-chat/workflow/components/AutoTaskPanel.vue';
import WorkspaceTabs from '@/features/llm-chat/workflow/components/WorkspaceTabs.vue';
