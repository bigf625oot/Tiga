...
import TechAnimation from '../message/TechAnimation.vue';
import MessageList from '../message/MessageList.vue';
import SmartQAInput from '../message/SmartQAInput.vue';
import SmartQAIntroFlipCards from '../message/SmartQAIntroFlipCards.vue';
