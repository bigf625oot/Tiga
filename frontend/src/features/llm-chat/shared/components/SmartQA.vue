...
// Subcomponents
import SmartQAHeader from './layout/SmartQAHeader.vue';
import SmartQAChatArea from './layout/SmartQAChatArea.vue';
import SmartQATaskPanel from '../../workflow/components/SmartQA/SmartQATaskPanel.vue';
import AttachmentDialog from './common/AttachmentDialog.vue';
import FileSidebar from './common/FileSidebar.vue';
import MemoDrawer, { type Memo } from './common/MemoDrawer.vue';
import DocPreviewPanel from './common/DocPreviewPanel.vue';
